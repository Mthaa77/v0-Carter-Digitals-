...
export const metadata: Metadata = {
  title: "Website Design & Development Pretoria | Carter Digitals",
  description:
    "Professional website design and development services in Pretoria. Custom, responsive, SEO-optimized websites for businesses in Tshwane and Gauteng.",
  keywords: [
    "website design Pretoria",
    "web development Pretoria",
    "website designer Centurion",
    "web developer Hatfield",
    "ecommerce website Pretoria",
    "responsive web design Tshwane",
    "SEO website development Pretoria",
    "affordable website design Pretoria",
  ],
  alternates: {
    canonical: "https://carterdigitals.com/services/pretoria",
  },
}
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <ServiceStructuredData
        name="Website Design & Development in Pretoria"
        description="Professional website design and development services for businesses in Pretoria and across Tshwane."
        url="https://carterdigitals.com/services/pretoria"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-light">
              Website Design & Development in Pretoria
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-foreground/80">
              Custom, responsive websites for businesses across Pretoria and Tshwane
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Our Web Services in Pretoria</h2>
      ...
      <section className="py-20 bg-gradient-to-b from-background to-background/90">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Areas We Serve in Pretoria</h2>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto">
            We provide professional web design and development services to businesses throughout Pretoria and
            surrounding areas:
          </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Why Choose Carter Digitals in Pretoria</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              {
                title: "Local Expertise",
                description:
                  "We understand the Pretoria market and create websites that resonate with local audiences.",
              },
              {
                title: "Affordable Pricing",
                description:
                  "Competitive rates without compromising on quality, designed to fit Pretoria business budgets.",
              },
              {
                title: "Responsive Support",
                description: "Quick response times and dedicated support for all our Pretoria clients.",
              },
              {
                title: "SEO Optimization",
                description: "We optimize your website to rank well in local Pretoria and South African searches.",
              },
              {
                title: "Custom Solutions",
                description: "Tailored web solutions that address the specific needs of your Pretoria business.",
              },
              {
                title: "Proven Results",
                description: "A portfolio of successful projects for businesses across Pretoria and Tshwane.",
              },
            ].map((point, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-b from-background to-background/90">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Start Your Web Project in Pretoria?</h2>
