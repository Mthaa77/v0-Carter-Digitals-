...
export const metadata: Metadata = {
  title: "Website Design & Development Cape Town | Carter Digitals",
  description:
    "Professional website design and development services in Cape Town. Custom, responsive, SEO-optimized websites for businesses in the Mother City and Western Cape.",
  keywords: [
    "website design Cape Town",
    "web development Cape Town",
    "website designer Sea Point",
    "web developer Stellenbosch",
    "ecommerce website Cape Town",
    "responsive web design Western Cape",
    "SEO website development Cape Town",
    "affordable website design Cape Town",
  ],
  alternates: {
    canonical: "https://carterdigitals.com/services/cape-town",
  },
}
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <ServiceStructuredData
        name="Website Design & Development in Cape Town"
        description="Professional website design and development services for businesses in Cape Town and across Western Cape."
        url="https://carterdigitals.com/services/cape-town"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-light">
              Website Design & Development in Cape Town
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-foreground/80">
              Custom, responsive websites for businesses across Cape Town and Western Cape
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Our Web Services in Cape Town</h2>
      ...
      <section className="py-20 bg-gradient-to-b from-background to-background/90">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Areas We Serve in Cape Town</h2>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto">
            We provide professional web design and development services to businesses throughout Cape Town and
            surrounding areas:
          </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">Why Choose Carter Digitals in Cape Town</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              {
                title: "Local Expertise",
                description:
                  "We understand the Cape Town market and create websites that resonate with local audiences.",
              },
              {
                title: "Affordable Pricing",
                description:
                  "Competitive rates without compromising on quality, designed to fit Cape Town business budgets.",
              },
              {
                title: "Responsive Support",
                description: "Quick response times and dedicated support for all our Cape Town clients.",
              },
              {
                title: "SEO Optimization",
                description: "We optimize your website to rank well in local Cape Town and South African searches.",
              },
              {
                title: "Custom Solutions",
                description: "Tailored web solutions that address the specific needs of your Cape Town business.",
              },
              {
                title: "Proven Results",
                description: "A portfolio of successful projects for businesses across Cape Town and Western Cape.",
              },
            ].map((point, index) => (
              <div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-b from-background to-background/90">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Start Your Web Project in Cape Town?</h2>
